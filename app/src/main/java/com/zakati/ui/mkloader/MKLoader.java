package com.zakati.ui.mkloader;
...
import com.ta.R;
import com.ta.ui.mkloader.callback.InvalidateListener;
import com.ta.ui.mkloader.type.LoaderView;
import com.ta.ui.mkloader.util.LoaderGenerator;
...
public class MKLoader extends View implements InvalidateListener {
  ...
  public void start() {
    AnimUtils.circularShow(this);

  }

  public void stop() {
    AnimUtils.circularHide(this);
  }
}
